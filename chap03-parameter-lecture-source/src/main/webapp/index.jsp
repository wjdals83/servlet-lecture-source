...
<body>
    ...
    <form action="querystring" method="get">
      ...
      <input type="checkbox" name="hobbies" id="sleep" value="sleep"><label for="sleep">자기</label>
      <br>
        <input type="submit" value="GET 요청">
    </form>
    <hr>
    <h4>a 태그의 href 속성에 직접 파라미터를 쿼리스트링  형태로 작성하여 get 요청</h4>
    <a href="querystring?name=서정민&age=20&birthday=2024-04-01&gender=F&national=ko&hobbies=movie&hobbies=music">
        쿼리스트링을 이용한 값 전달
    </a>
    <hr>
    ...
    <form action="formdata" method="post">
        ...
        <input type="checkbox" name="hobbies" id="sleep1" value="sleep"><label for="sleep1">자기</label>
        <br>
